...
export default function Home() {
  ...
  const fetchAllData = useCallback(async (currentFilters: AnalyticsFilters) => {
    try {
      ...
      console.log('🔍 Starting data fetch with filters:', currentFilters)
      console.log('🔗 API URL:', process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000')

      // Test health endpoint first
      try {
        const healthUrl = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/health`
      ...
      console.log('📊 All data fetched successfully:', {
        ...
        digitalInterest: digitalInterestResponse,
